...
export interface ApiBildgalerieBildgalerie extends Struct.CollectionTypeSchema {
  collectionName: 'bildgaleries';
  info: {
    displayName: 'Bildgalerie';
    pluralName: 'bildgaleries';
    singularName: 'bildgalerie';
  };
  options: {
...
export interface ApiVeranstaltungVeranstaltung
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Datum_Bis: Schema.Attribute.Date;
    Datum_Von: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
